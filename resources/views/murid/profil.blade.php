...
<div class="row">
      ...
      <div class="card shadow mb-4">
        <div class="card-body">
            <div class="row justify-content-left">
                ...
                <div class="col-lg-4">
                    <div class="row"><h2 class="mt-5">Nama: {{ $profil['nama_lengkap'] }}</h2></div>
                    <div class="row"><h2 class="mt-4">Email: {{ $profil['email'] }}</h2></div>
                    <div class="row"><h2 class="mt-4">No. Telepon: {{ $profil['no_hp'] }}<h2></div>
                    <div class="row"><h2 class="mt-4">Asal Sekolah: {{ $profil['asal_sekolah'] }}</h2></div>
                    <div class="row"><h2 class="mt-4">Alamat: {{ $profil['alamat'] }}</h2></div>
                </div>
    ...
    <!-- Modal -->
    <div class="modal fade modalEditProfil" id="ModalEditProfil" tabindex="-1" role="dialog" aria-labelledby="ModalEditProfilTitle" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <figure class="figure text-center">
                            <img src="{{URL::asset(session('image_profil'))}}" class="img-thumbnail rounded-circle" style="width: 200px; height: 200px;">
                        </figure>
                    </div>
                    <div class="col-lg-6">

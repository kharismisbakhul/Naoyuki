        ...
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            <div class="text-xs font-weight-bold text-danger mb-1">
              Jumlah Kelas Berjalan</div>
            <div class="h4 mb-0 font-weight-bold text-gray-800 mt-3"><span></span>{{ $jumlah_kelas }} Kelas
            </div>
          </div>
          <div class="col-auto">
      ...
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            <div class="text-xs font-weight-bold text-danger mb-1">
              Jumlah Murid</div>
            <div class="h4 mb-0 font-weight-bold text-gray-800 mt-3"><span></span> {{ $jumlah_murid }} Murid
            </div>
          </div>
          <div class="col-auto">
            <i class="fas fa-users fa-4x text-danger"></i>

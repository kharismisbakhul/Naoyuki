        ...
        <form action="{{ url('/akademik/tambahKelas') }}" method="post">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                ...
                <input type="text" class="form-control" id="nama_program_temp" name="nama_program_temp" value="{{ $program_les->nama_program_les }}" readonly>
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <button class="btn btn-danger col-sm-1"><i class="fas fa-fw fa-plus text-white"></i></button>
              </div>
            <div class="form-group row">
                <label for="hariPertemuan" class="col-sm-3 col-form-label">Waktu Pertemuan 1</label>
                <div class="col-sm-5">
            ...
            <div class="form-group row">
                <label for="hariPertemuan" class="col-sm-3 col-form-label">Waktu Pertemuan 2</label>
                <div class="col-sm-5">
                  <select class="form-control" id="hariPertemuan" name="hariPertemuan">
                    <option value="" hidden selected>Pilih Hari</option>
                    @foreach ($hari as $h)
